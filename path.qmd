...
![In the menu at the top, choose Analyses -\> SEM -\> Path Analysis.](images/path29.png){width="75%"}
...
![Parameters Options. Check Inderect Effects.](images/path006.png){width="75%"}  
...
![Indirect effects.](images/path005.png){#fig-path005 width="95%"}
