...
![Parameters Options. Check Inderect Effects.](images/path006.png){width="65%"}  
...
![Indirect effects.](images/path005.png){#fig-path005 width="85%"}
...
![Path diagram of the model with observed variables.](images/path33.png){#fig-path33 width="75%"}
