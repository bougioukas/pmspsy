...
![In the menu at the top, choose Analyses -\> medmod -\> Mediation.](images/path11.png){#fig-path11 width="65%"}
...
![Mediation box choices.](images/path12.png){#fig-path12 width="65%"}
...
![Path estimates.](images/path13.png){#fig-path13 width="65%"}
...
![Mediation estimates.](images/path14.png){#fig-path14 width="65%"}

 

We can also represent the mediation estimates in a plot:

![Mediation estimates plot.](images/path15.png){#fig-path15 width="65%"}
...
![The conditional mediation model diagram.](images/path16.png){#fig-path16 width="65%"}
...
![Linear regression dialog box for Y.](images/path19.png){#fig-path19 width="65%"}

![Model coefficients for Y.](images/path20.png){#fig-path20 width="65%"}
...
![Path diagram with model estimates for females (Z=0).](images/path24.png){#fig-path24 width="65%"}

Therefore, the **total effect** is the sum of conditional direct and indirect effects: 0.373 + (- 0.0035) = 0.367.

![Path diagram with model estimates for males (Z=1).](images/path25.png){#fig-path25 width="65%"}
...
![In the menu at the top, choose Analyses -\> medmod -\> GLM Mediation Analysis.](images/path26.png){#fig-path26 width="65%"}

 

![GLM Mediation model dialog box.](images/path21.png){#fig-path21 width="65%"}

![Model building choices.](images/path22.png){#fig-path22 width="65%"}
...
![Model diagram.](images/path27.png){#fig-path27 width="90%"}
...
![In the menu at the top, choose Analyses -\> SEM -\> Path Analysis.](images/path29.png){width="65%"}



The Path Analysis dialog box opens. From the left-hand pane drag the variables `behavior` and `intention` into the *Endogenous Variable* field, and the variables `attitude`, `norms` into the *Mediator* field, and the `grades` variable into the *Predictor* field as shown below (@fig-path12).

![Path analysis dialog box.](images/path003.png){#fig-path003 width="65%"}
...
![Endogenous Model determination.](images/path30.png){#fig-path30 width="65%"}

 

Under the "Parameter Options", also check the *Indirect Effects*.

![Parameters Options. Check Inderect Effects.](images/path006.png){#fig-path30 width="65%"}
 
...
The indirect effects are reported in the following table:

![Indirect effects.](images/path005.png){#fig-path30 width="65%"}


Moreover, using path analysis, we can explicitly model the variance of the exogenous variables, the covariances (correlations) between the exogenous variables, and the residual errors of the endogenous variables in the model.


![Variances and Covariances estimates.](images/path32.png){#fig-path32 width="85%"}


 

We can also present the model with a path diagram. All options regard aestetics of the diagram are shown in @fig-path34. 

![Path Diagram choices. Check Residuals for variances (residual errors). ](images/path34.png){#fig-path34 width="65%"}

![Path diagram of the model.](images/path33.png){#fig-path33 width="75%"}
