...
$$
\begin{aligned}
\widehat{\text{weight}} &= b_o + b_1 \cdot x_1 + b_2 \cdot x_2\\
...
The interaction term is statistically significant (Estimate = 57, p < 0.001), suggesting that the effect of height on body weight differs by gender.
