...
We select Principal axis for extraction method and Oblimin (default) for rotation method:

![Select the Principal Axis dor extraction and Oblimin method of rotation.](images/fa3.png){#fig-fa3 width="35%"}
