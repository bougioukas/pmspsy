...
-   **Oblique Rotation:** Use this if you believe the components are correlated or related (although at that point, exploratory factor analysis (EFA) might be the more technically appropriate model).
