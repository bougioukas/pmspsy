...
This diagram illustrates how the observed variables can be grouped together, allowing us to identify the following underlying conceptual dimensions (components):
