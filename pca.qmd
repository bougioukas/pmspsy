...
If our scale construction includes a priori or planned subscales, we expect the observed variables to cluster together according to their underlying conceptual dimensions. For example, in our case, we anticipate the following groupings (components):
